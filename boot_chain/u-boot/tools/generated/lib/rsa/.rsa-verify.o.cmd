cmd_tools/generated/lib/rsa/rsa-verify.o := cc -Wp,-MMD,tools/generated/lib/rsa/.rsa-verify.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu11      -DCONFIG_FIT_SIGNATURE -DCONFIG_FIT_SIGNATURE_MAX_SIZE=0xffffffff -DCONFIG_FIT_CIPHER -include ./include/compiler.h -idirafterinclude -idirafter./lib/mbedtls -idirafter./lib/mbedtls/port -idirafter./lib/mbedtls/external/mbedtls -idirafter./lib/mbedtls/external/mbedtls/include -idirafter./arch/arm/include -idirafter./dts/upstream/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/generated/lib/rsa/rsa-verify.o tools/generated/lib/rsa/rsa-verify.c

source_tools/generated/lib/rsa/rsa-verify.o := tools/generated/lib/rsa/rsa-verify.c

deps_tools/generated/lib/rsa/rsa-verify.o := \
  include/compiler.h \
  tools/../lib/rsa/rsa-verify.c \
    $(wildcard include/config/rsassa/pss.h) \
    $(wildcard include/config/rsa/verify/with/pkey.h) \
...
tools/generated/lib/rsa/rsa-verify.o: $(deps_tools/generated/lib/rsa/rsa-verify.o)
